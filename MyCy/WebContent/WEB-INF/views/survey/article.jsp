...
<link href="<%=cp%>/res/bootstrap/css/bootstrap.min.css" rel="stylesheet">
...
function check() {
	...
	f.action="<%=cp%>/survey/submit_ok.do";
	...
	<div class="container" role="main">
		<div class="bodyFrame col-sm-10"
			...
			<div style="margin-top: 50px;">
				<form name="articleForm" method="post" onsubmit="return check();">
					...
					<div class="bs-write">
						<table class="table">
							<tbody>
								<tr>
									<td colspan="4" class="td1">
										<div class="alert alert-info">
											<h3>
												<i class="glyphicon glyphicon-info-sign"></i> Q.&nbsp;${dto.title}
											</h3>
										</div>
									</td>
								</tr>
								...
								<tr align="right">
										<td colspan="4"><b>마감 시간 ${dto.enddate}</b><hr></td>
								</tr>
									...
									<tr>
										...
										<td style="font-size: 20px;" align="left">&nbsp;&nbsp;
											...
											<input name="answer"
													...
													type="${dto.choice == 0 ? 'radio' : 'checkbox'}"
													value="${stat.index}">&nbsp;&nbsp;${quest}
											</label> 
										</td>
									</tr>
								</c:forEach>
